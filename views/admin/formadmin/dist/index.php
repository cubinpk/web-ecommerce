...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                                <div class="sb-nav-link-icon"><i class="fas fa-question-circle"></i></i></div>
                                Thông tin
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            ...
                            <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="401.php">Thêm loại sản phẩm</a>
                                    <a class="nav-link" href="404.php">Danh sách loại sản phẩm</a>
                            ...
                            <div class="collapse" id="pagesCollapseError1" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="401.php">Thêm thương hiệu</a>
                                    <a class="nav-link" href="404.php">Danh sách thương hiệu</a>
                            ...
                            <div class="collapse" id="pagesCollapseError2" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="401.php">Thêm sản phẩm</a>
                                    <a class="nav-link" href="tables.php">Danh sách sản phẩm</a>
        ...
        <script src="/phong1312/views/admin/formadmin/dist/js/scripts.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
        <script src="/phong1312/views/admin/formadmin/dist/assets/demo/chart-area-demo.js"></script>
        <script src="/phong1312/views/admin/formadmin/dist/assets/demo/chart-bar-demo.js"></script>
        <script src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js" crossorigin="anonymous"></script>
        <script src="https://cdn.datatables.net/1.10.20/js/dataTables.bootstrap4.min.js" crossorigin="anonymous"></script>
        <script src="/phong1312/views/admin/formadmin/dist/assets/demo/datatables-demo.js"></script>
    </body>
</html>
